...
const variants = {
  primary: 'border border-[#a07a28]/25 bg-sid-gold font-semibold text-[#1a3a28] hover:bg-[#e8c96a] focus:ring-sid-gold',
...
<template>
  ...
  >
    <svg
      v-if="loading"
      class="-ml-0.5 mr-2 h-4 w-4 animate-spin text-current"
