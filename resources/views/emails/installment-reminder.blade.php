...
<head>
    ...
    <title>Lembrete de vencimento — Sid360 Imóveis</title>
    <style>
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <p>Lembrete de vencimento</p>
            </div>
            <div class="body">
                <p>Olá, <strong>{{ $clientName }}</strong>!</p>
                <p>Sua parcela vence em <strong>{{ $daysBefore }} dias</strong>. Fique em dia para evitar multas.</p>
                <table class="data-table">
                    ...
                    <tr>
                        <td>Parcela</td>
                        <td>{{ $installment->type === \App\Models\Installment::TYPE_DOWN_PAYMENT ? 'Entrada' : 'Parcela ' . $installment->number }}</td>
                    </tr>
                    <tr>
                        <td>Valor</td>
                        <td>{{ $value }}</td>
                ...
                <p style="text-align: center;">
                    <a href="{{ config('app.url') }}/pagamentos" class="btn">Ver 2ª via / PIX</a>
                </p>
                <p class="muted">(74) 9 8823-0151</p>
            </div>
            <div class="footer">
